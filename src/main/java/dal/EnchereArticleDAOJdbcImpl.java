...
public class EnchereArticleDAOJdbcImpl implements EnchereArticleDAO {
	private static final String SELECTJOIN ="select a.nom_article,e.montant_enchere,a.prix_initial,a.date_fin_enchere,a.etat_vente,u.pseudo from ARTICLES_VENDUS a left join ENCHERES e on a.no_article = e.no_article inner join UTILISATEURS u on a.no_utilisateur = u.no_utilisateur";
	...
	public List<EnchereArticle> selectJoin() {
		...
		try (Connection cnx = ConnectionProvider.getConnection();){
			...
			while (rs.next()) {
				...
				EnchereArticle ea = new EnchereArticle(nom_article, prix_initial, date_fin_enchere, etat_vente, pseudo, montant_enchere);
