		            ...
		            <c:forEach var="utilisateur" items="${listUtil}">
		                <tr>
		                    ...
		                    <div class="d-flex justify-content-between">
		                        ...
		                        <form class="mx-4" method="get" action="<%=request.getContextPath()%>/admin/disableUser/${utilisateur.noUtilisateur}" id="disable-user-form-${utilisateur.noUtilisateur}">
								    <div class="form-check form-switch">
								        <input class="form-check-input" type="checkbox" name="actif" id="actif-${utilisateur.pseudo}"
								            ${utilisateur.actif ? "checked" : ""} onchange="disableUser(this, ${utilisateur.noUtilisateur})">
								        <label class="form-check-label" for="actif-${utilisateur.pseudo}">
								...
								href="<%=request.getContextPath()%>/admin/deleteUser/${utilisateur.noUtilisateur}"><span class="bi bi-trash"></span></a>
		                        </div>
		                    </td>
		                </tr>
		            </c:forEach>
